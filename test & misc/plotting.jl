...
# ╔═╡ f0cd4946-eabb-11ee-1d35-fb3bb839f716
begin
	using Plots
	using PlutoUI
	using LaTeXStrings
...
# ╔═╡ f27ae797-3499-4c27-a53c-ae9ca5150b05
sol = readdlm("results/stabilitySolutions2/40.12.84500.stabSol.csv", ',', Complex{Float64})

# ╔═╡ 7a112818-8207-4d51-a0fd-c9afe4b358b9
stabilityPlotsGPU(sol, 84500)

# ╔═╡ f9fa7f3c-200f-4de2-8963-adda8381e316
begin
	plots = stabilityPlots(sol, 84500)
	ylims!(-1e-10, 1e-10)
	xlims!(0.04, 0.045)
end

# ╔═╡ b5a7d783-19b4-4d91-a7dd-0abdd3e200ce
begin
	plots
	# ylims!(-1e-10, 1e-10)
	xlims!(0.042, 0.044)
...
manifest_format = "2.0"
project_hash = "e67c3cae1f70b05ce2f8f9e040d6627c5e4751f0"
